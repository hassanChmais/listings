...
<table>
    <tbody>
        <tr>
            ...
            <td><img src="{{$media->getUrl('thumb')}}" /><a href="{{route('listings.deletePhoto',[$listing->id,$media->id])}}" style="color: red;" class="text-indigo-600 hover:text-indigo-900">delete</a></td>
            @endforeach
        </tr>
    </tbody>
</table>
